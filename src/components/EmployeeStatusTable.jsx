...
const EmployeeStatusList = () => {
  ...
  const handleViewList = (section) => {
    console.log(`View List clicked for ${section}`);
  };
  ...
  return (
    <div className="bg-white px-4 rounded-lg">
      ...
      <div className="grid grid-cols-3 gap-6 p-3 border-t mt-2">
        <div className="flex items-center gap-1 text-blue-500 cursor-pointer" onClick={() => handleViewList("checkinInfo")}>
          <span>View List</span>
          <MdArrowForwardIos className="text-sm" />
        </div>
        <div className="flex items-center gap-1 text-blue-500 cursor-pointer" onClick={() => handleViewList("attendance")}>
          <span>View List</span>
          <MdArrowForwardIos className="text-sm" />
        </div>
        <div className="flex items-center gap-1 text-blue-500 cursor-pointer" onClick={() => handleViewList("leaveApplications")}>
          <span>View List</span>
          <MdArrowForwardIos className="text-sm" />
        </div>
      </div>
